...
// @Accept       json
// @Produce      json
// @Param        body  body  usecase.RegisterReq  true  "Registration payload"
...
// @Accept       json
// @Produce      json
// @Param        body  body  usecase.LoginReq  true  "Login payload"
...
func (h *AuthHandler) WSToken(c *gin.Context) {
	...
	if err != nil {
		...
		response.Error(c, 401, "authentication failed")
		return
	}
