...
const file_auth_proto_rawDesc = "" +
	...
	"\x05error\x18\x05 \x01(\tR\x05error2\xd9\x01\n" +
	"\vAuthService\x12H\n" +
	...
	"\x0eValidateAPIKey\x12\x1b.auth.ValidateAPIKeyRequest\x1a\x1c.auth.ValidateAPIKeyResponseB(Z&github.com/cryptox/shared/proto/authpbb\x06proto3"
...
var file_auth_proto_goTypes = []any{
	...
	(*ValidateAPIKeyRequest)(nil),  // 4: auth.ValidateAPIKeyRequest
	(*ValidateAPIKeyResponse)(nil), // 5: auth.ValidateAPIKeyResponse
}
var file_auth_proto_depIdxs = []int32{
	...
	4, // 2: auth.AuthService.ValidateAPIKey:input_type -> auth.ValidateAPIKeyRequest
	1, // 3: auth.AuthService.ValidateToken:output_type -> auth.ValidateTokenResponse
	3, // 4: auth.AuthService.GetUser:output_type -> auth.UserResponse
	5, // 5: auth.AuthService.ValidateAPIKey:output_type -> auth.ValidateAPIKeyResponse
